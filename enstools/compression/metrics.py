...
class AvailableMetrics:
    """
    A class to hold the list of available metrics and update it when needed.
    """
    @property
    def get(self):
        """
        ...
        Returns:
            dict: A dictionary of available metrics with function names as keys and function objects as values.
        """
